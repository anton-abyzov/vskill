---
description: Generate documentation from TypeScript/JavaScript code, OpenAPI specs, GraphQL schemas, and project specifications.
---

# Generate Documentation from Code

Generate documentation automatically from TypeScript/JavaScript code, OpenAPI specs, GraphQL schemas, and project specifications. Creates comprehensive API docs, type references, and usage examples.
...
```bash
/docs-generate openapi ./api/openapi.yaml \
  --output ./docs/api \
  --interactive
```
...
### 3. GraphQL Schema
```bash
/docs-generate graphql ./schema.graphql \
  --output ./docs/graphql
```

### 4. Living Docs
```bash
/docs-generate living-docs ./docs \
  --output ./docs/specs \
...
Generates consolidated documentation from `docs/`:

**Input**: Project docs directory structure
```
docs/
├── features/
│   ├── FS-001/
  ...
  docs:
    ...
    steps:
      ...
      - name: Generate API docs
        run: |
          npm install
          npx claude /docs-generate code ./src
...
Auto-sync living docs features, user stories, and modules to documentation site.
...
/docs-generate code ./src --output ./docs/api
/docs-generate openapi ./api/openapi.yaml --output ./docs/api
/docs-generate living-docs ./docs --output ./docs/specs
...
/docs-generate code ./src --output ./docs/en --lang en
/docs-generate code ./src --output ./docs/es --lang es
/docs-generate code ./src --output ./docs/fr --lang fr
```
...
```bash
/docs-generate openapi ./api/v1/openapi.yaml \
  --output ./docs/api/v1 \
  --interactive \
  --group-by tag
```
